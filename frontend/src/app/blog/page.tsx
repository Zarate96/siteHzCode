      ...
      <div className="max-w-5xl mx-auto">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogs.map((blog, idx) => (
              <article key={idx} className="bg-[#161b22] border border-gray-700 rounded-lg overflow-hidden hover:border-blue-500 hover:-translate-y-1 transition-all duration-300">
                <div className="h-48 bg-gray-800 w-full overflow-hidden flex items-center justify-center text-gray-500">
